...
class Texts {
	 ...
	 * Text label.
	 */
	public static final String LABEL_REGULAR_NEURON_COLOR = "REGULAR NEURON color";
	 ...
	 * Text label.
	 */
	public static final String LABEL_INPUT_OUTPUT_NEURON_COLOR = "INPUT-OUTPUT NEURON color";

	/**
	 * Text label.
	 */
	public static final String LABEL_INPUT_BIAS_NEURON_COLOR = "INPUT-BIAS NEURON color";

	/**
	 * Text label.
	 */
	public static final String LABEL_OUTPUT_BIAS_NEURON_COLOR = "OUTPUT-BIAS NEURON color";

	/**
	 * Text label.
	 */
	public static final String LABEL_INPUT_OUTPUT_BIAS_NEURON_COLOR = "INPUT-OUTPUT-BIAS NEURON color";
	 ...
	 * Text label.
	 */
	public static final String LABEL_NEURONS_NUMBERS_SIZE = "Size of neurons' numbers";

	/**
	 * Text label.
	 */
	public static final String LABEL_WORK_AREA_BACKGROUND_COLOR = "Work area background color";
	 ...
	 * Information message.
	 */
	public static final String INFORMATION_SELECT_ANN_ID_TITLE = "Missing information";

	/**
	 * Information message.
	 */
	public static final String INFORMATION_SELECT_SYMBOL_AND_PERIOD = "Select symbol, period and number of neurons.";

	/**
	 * Information message.
	 */
	public static final String INFORMATION_SELECT_SYMBOL_AND_PERIOD_TITLE = "Missing information";

	/**
	 * Error message.
	 */
	public static final String ERROR_DATABASE_PORT = "Invalid database port value.";

	/**
	 * Error message.
	 */
	public static final String ERROR_DATABASE_CONNECT = "Invalid credentials. Connection failed.";
	 ...
	 * Error message.
	 */
	public static final String ERROR_LOAD_CURRENCY_PAIRS_LIST = "Load currency pairs list fail.";

	/**
	 * Error message.
	 */
	public static final String ERROR_LOAD_PERIODS_LIST = "Load periods list fail.";

	/**
	 * Error message.
	 */
	public static final String ERROR_NUMBER_DATABASE_RESULTS = "Wrong number of database results.";
