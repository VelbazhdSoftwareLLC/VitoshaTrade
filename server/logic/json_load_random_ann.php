 ...
 *                                                                             *
 * Copyright (C) 2008-2018 by Todor Balabanov  ( todor.balabanov@gmail.com )   *
 *                                                                             *
 ...
 * Prepare SQL query.
 */
$sql = 'select  currency_pairs.symbol, time_periods.minutes, ann.fitness, ann_kind.number_of_neurons, ann_kind.flags, ann.weights, ann_kind.activities from ann, ann_kind, currency_pairs, time_periods where ann_kind.currency_pairs_id=currency_pairs.id and currency_pairs.period_id=time_periods.id and ann.ann_kind_id=ann_kind.id order by rand() limit   1;';
