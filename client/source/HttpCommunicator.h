...
private:
	 ...
	 * @date 10 May 2009
	 */
	void loadAnnList(std::vector<int> &list, int annId, char symbol[], TimePeriod period);
...
public:
	 ...
	 * @date 26 Aug 2009
	 */
	void loadTrainerObjects(Counter &counters, ANN &ann, DE &de, int dbId, char symbol[], TimePeriod period, int neuronsAmount, int populationSize, int bars);
	 ...
	 * @date 10 May 2009
	 */
	void saveSingleANN(char *symbol, TimePeriod period, double fitness, NeuronsList &neurons, WeightsMatrix &weights, ActivitiesMatrix &activities);
	 ...
	 * @date 26 Aug 2009
	 */
	void loadSingleANN(int annId, char *symbol, TimePeriod &period, double &fitness, NeuronsList &neurons, WeightsMatrix &weights, ActivitiesMatrix &activities);
	 ...
	 * @date 22 Sep 2009
	 */
	void saveTrainingSet(char symbol[], TimePeriod period, const std::vector<RateInfo> &rates, int size);
	 ...
	 * @date 22 Sep 2009
	 */
	void loadTrainingSet(char symbol[], TimePeriod period, std::vector<RateInfo> &rates, int size);
	 ...
	 * @date 10 May 2009
	 */
	double loadRemoteBestFitness(char *symbol, TimePeriod period, NeuronsList &neurons, ActivitiesMatrix &activities);
