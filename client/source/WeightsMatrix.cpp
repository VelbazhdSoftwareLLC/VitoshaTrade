...
WeightsMatrix::WeightsMatrix() : GraphMatrix() {
}

WeightsMatrix::WeightsMatrix(int size) : GraphMatrix(size) {
}

WeightsMatrix::WeightsMatrix(const WeightsMatrix &weights) : GraphMatrix(weights) {
}
